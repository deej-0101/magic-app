...
from magic_app.models import MagicalCreature, Wizard, EnchantedPlace, MagicalEvent, MagicalEncounter
...
class Command(BaseCommand):
    ...
    def create_magical_data(self):
        ...
        # Create Wizards
        wizard1 = Wizard(name="Merlin", email="thegreatmerlin@wizard.com", magical_abilities="Sorcery, Transfiguration", birth_date=date(500, 6, 20), magical_wand="Oak, Dragon Heartstring")
        wizard1.save()

        wizard2 = Wizard(name="Morgana", email="morganathegreat@wizard.com", magical_abilities="Dark Magic, Shape-shifting", birth_date=date(520, 9, 15), magical_wand="Ebony, Basilisk Fang")
        wizard2.save()
